...
class SequenceSequenceECCAssociation(db.Model):
	...
	tedistill_method_id = db.Column(db.Integer, db.ForeignKey('tedistill_methods.id', ondelete='CASCADE'))
	te_class_method_id = db.Column(db.Integer, db.ForeignKey('te_class_methods.id', ondelete='CASCADE'))
	...
	tedistill_method = db.relationship('TEdistillMethod', lazy='joined',
										 backref=db.backref('ecc_as_tedistill_method',
															lazy='dynamic',
															passive_deletes=True)
										 )
	
	te_class_method = db.relationship('TEClassMethod', lazy='joined',
										 backref=db.backref('ecc_as_te_class_method',
															lazy='dynamic',
															passive_deletes=True)
										 )
