...
Before you begin, make sure you are in the correct directory and have the virtual environment active. Questions??? Read "README_populate" again.

To access the scripts, enter the add folder:

```bash
cd Conekt/scripts/add
```
