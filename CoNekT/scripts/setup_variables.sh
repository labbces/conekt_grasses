...
BASE_DIR=/path/to/conekt_grasses
...
SPECIES_ARRAY=( Bdi Osa Sbi Shy Sit Sof Ssp Svi Pvi Zma Zma1 )

#
SPECIES_EXPRESSION_PROFILES=( Bdi Osa Sbi Shy Sit Sof Ssp Svi Pvi Zma Zma1 )
