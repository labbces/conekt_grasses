...
# # # Erro, falta o arquivo Functional Data/TRs/RulesFull_Jennifer_JEIN_05122024.txt
...
# # # Erro, falta o arquivo Transposable Elements/TE_Classes.tsv
...
# # Funcionando parcialmente, falta o arquivo Species/Zma/Zma_tes.fa
...
# # Sem os dados de arroz por enquanto
...
# # Erro, não tenho o arquivo Transposable Elements/TEdistill_sequences.fa
