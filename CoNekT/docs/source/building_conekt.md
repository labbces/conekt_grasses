...
Step-by-step instructions
  ...
  * [Adding GO term, InterPro domain and CAZymes definitions](https://github.com/labbces/conekt_grasses/blob/arthur_documentation/CoNekT/docs/source/building/001_GO_InterPro_CAZymes_domains.md)
